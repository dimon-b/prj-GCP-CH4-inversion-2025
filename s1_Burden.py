...
class LossCorr(_set_case.SetCase):
    ...
    def run_fort_burdlos(self):
        ...
        # --- Patch FORTRAN source (lines 8–9)
        try:
            ...
            print("Patched s1_ch4_burloss.f90:")
            print(f"    ch4_dir  = {self.inv_mod_dir}")
            print(f"    work_dir = {self.inv_wrk_dir}")
            print('')

        except Exception as e:
            raise RuntimeError(f"ERROR patching Fortran file: {e}")
